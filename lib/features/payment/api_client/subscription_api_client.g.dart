...
class _SubscriptionApiClient implements SubscriptionApiClient {
  _SubscriptionApiClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<SubscriptionResponse> createSubscription(FormData formData) async {
    ...
    final _options = _setStreamType<SubscriptionResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://scopeybackend-omaimasayedmohamed2022.onrender.com/subscriptions',
  ...
  Future<SubscriptionResponse> getMySubscription() async {
    ...
    final _options = _setStreamType<SubscriptionResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'https://scopeybackend-omaimasayedmohamed2022.onrender.com/subscriptions/me',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
